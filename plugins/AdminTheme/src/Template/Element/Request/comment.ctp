...
<div class="md-modal md-slide-stick-top" id="md-add-request_comment" >
    <div class="md-content" style="height: 600px !important;overflow-y: scroll;">
        ...
        <h3><strong>Request Detail</strong></h3>
        <div class="widget">
            <!-- Begin timeline -->
            <div class="the-timeline" >
                <form class="form-horizontal" role="form" id="frRequestComment" enctype="multipart/form-data">
                    <div class="form-group">
                        <textarea class="form-control" style="height: 70px;" id="txtComment" name="txtComment" placeholder="Enter Your Comment..."></textarea>
                    </div>
                ...
                <br><br>
                <ul style="padding: 0px" class="listComment">
                </ul>
