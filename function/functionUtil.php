...
define("MCRYPT_KEY","master4561");
	...
	function getDevelopMode(){
			...
			if((preg_match("#local#",$hostname)))    $develop_mode="dev";
			if((preg_match("#son#",$hostname)))    $develop_mode="local";
			if((preg_match("#hayahide#",$hostname))) $develop_mode="dev";
			return $develop_mode;
	}
